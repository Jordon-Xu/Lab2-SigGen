...
VL_ATTR_COLD void Vsigdelay___024root___stl_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsigdelay__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsigdelay___024root___stl_sequent__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vsigdelay___024root___eval_stl(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vsigdelay___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->sigdelay__DOT__ram_dout = VL_RAND_RESET_I(8);
