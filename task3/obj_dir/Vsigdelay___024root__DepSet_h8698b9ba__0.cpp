...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    __Vdlyvdim0__sigdelay__DOT__ram_inst__DOT__ram_array__v0 = 0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__ram_inst__DOT__ram_array__v0;
    __Vdlyvval__sigdelay__DOT__ram_inst__DOT__ram_array__v0 = 0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__ram_inst__DOT__ram_array__v0;
    __Vdlyvset__sigdelay__DOT__ram_inst__DOT__ram_array__v0 = 0;
    SData/*8:0*/ __Vdly__sigdelay__DOT__wr_addr;
    __Vdly__sigdelay__DOT__wr_addr = 0;
    // Body
    ...
    if (vlSelf->rd) {
        vlSelf->sigdelay__DOT__ram_dout = vlSelf->sigdelay__DOT__ram_inst__DOT__ram_array
    ...
    vlSelf->delayed_signal = vlSelf->sigdelay__DOT__ram_dout;
}
