...
void Vsinegen___024root__trace_chg_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelf->sine_value1),8);
    bufp->chgCData(oldp+5,(vlSelf->sine_value2),8);
    bufp->chgCData(oldp+6,(vlSelf->sinegen__DOT__counter_value),8);
    bufp->chgCData(oldp+7,(vlSelf->incr),8);
    bufp->chgCData(oldp+8,((0xffU & ((IData)(vlSelf->sinegen__DOT__counter_value) 
                                     + (IData)(vlSelf->incr)))),8);
}
