...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    __Vdly__sinegen__DOT__counter_value = ((IData)(vlSelf->rst)
                                            ? 0U : 
                                           (0xffU & 
                                            ((IData)(vlSelf->sinegen__DOT__counter_value) 
                                             + (IData)(vlSelf->en))));
    vlSelf->sine_value1 = vlSelf->sinegen__DOT__rom_inst__DOT__rom_array
        [vlSelf->sinegen__DOT__counter_value];
    vlSelf->sine_value2 = vlSelf->sinegen__DOT__rom_inst__DOT__rom_array
        [(0xffU & ((IData)(vlSelf->sinegen__DOT__counter_value) 
                   + (IData)(vlSelf->incr)))];
