...
VL_ATTR_COLD void Vsinegen___024root__trace_init_sub__TOP__0(Vsinegen___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"sine_value1", false,-1, 7,0);
    tracep->declBus(c+6,"sine_value2", false,-1, 7,0);
    ...
    tracep->declBus(c+5,"sine_value1", false,-1, 7,0);
    tracep->declBus(c+6,"sine_value2", false,-1, 7,0);
    tracep->declBus(c+7,"counter_value", false,-1, 7,0);
...
VL_ATTR_COLD void Vsinegen___024root__trace_full_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->sine_value1),8);
    bufp->fullCData(oldp+6,(vlSelf->sine_value2),8);
    bufp->fullCData(oldp+7,(vlSelf->sinegen__DOT__counter_value),8);
    bufp->fullCData(oldp+8,(vlSelf->incr),8);
    bufp->fullCData(oldp+9,((0xffU & ((IData)(vlSelf->sinegen__DOT__counter_value) 
                                      + (IData)(vlSelf->incr)))),8);
